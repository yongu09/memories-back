package com.jjy.memories_back.config;
...
import com.jjy.memories_back.handler.OAuth2SuccessHandler;
...
// description: CORS 정책은 모든 출처 및 리소스에 대해서 허용하도록 만들 것 //
@Configurable
@Configuration
@EnableWebSecurity
